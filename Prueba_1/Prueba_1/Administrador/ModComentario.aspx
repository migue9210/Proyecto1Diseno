        ...
        <legend>Formulario de registro</legend>
            <ol>
                <li>
                    ...
                    <asp:ListBox ID="ListBoxDestino" runat="server" Height="24px" Width="309px" style="font-size: medium" DataSourceID="SqlDataSource1" DataTextField="NOMBRE" DataValueField="ID_COMENTARIO"></asp:ListBox>                                
